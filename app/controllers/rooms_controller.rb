class RoomsController < ApplicationController
  ...
  def show
    ...
    @token = opentok.generate_token @room.vonage_session_id, { email: current_user.email}
  end
  ...
  def create
    ...
    respond_to do |format|
      if @room.save
        @room.url = request.original_url+"/"+@room.id.to_s
        @room.save
  ...
  private
    ...
    def room_params
      params.require(:room).permit(:name, :vonage_session_id, :user_id, :start_date, :end_date, :url)
    end
end
